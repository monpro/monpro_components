...
export interface SwitchToggleProps extends Omit<InputHTMLAttributes<HTMLElement>, 'onChange'> {
  id: string;
  name?: string;
  checked: boolean;
  ...
  return (
    <div className="mon-toggle-switch">
      ...
      <label className="mon-toggle-switch-label" htmlFor={name}>
        <span className="mon-toggle-switch-inner" yes-text={optionalLabels[0]} no-text={optionalLabels[1]}/>
